...
export function withNetworkMonitoring<T extends (...args: any[]) => Promise<any>>(
  ...
  return async (...args: Parameters<T>): Promise<ReturnType<T>> => {
    console.log('withNetworkMonitoring - args received:', args);
    console.log('withNetworkMonitoring - args length:', args.length);
    ...
    const wrappedFn = async () => {
      console.log('withNetworkMonitoring - calling original function with args:', args);
